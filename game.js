...
const links = [
  { text: "GitHub", url: "https://github.com/vruntime-labs", x: 120, y: 388, w: 70, h: 20 },
  { text: "Instagram", url: "https://www.instagram.com/vruntimelabs/", x: 250, y: 388, w: 80, h: 20 },
  { text: "YouTube", url: "https://www.youtube.com/@vruntimelabs", x: 380, y: 388, w: 70, h: 20 }
];
...
// Touch / Button Control Listeners
...
function update() {
  user.y += user.dy;
  user.y = Math.max(0, Math.min(canvas.height - 30 - user.height, user.y));

  ai.y += (ball.y - (ai.y + ai.height / 2)) * 0.08;
  ai.y = Math.max(0, Math.min(canvas.height - 30 - ai.height, ai.y));
